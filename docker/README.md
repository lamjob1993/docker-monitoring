...
- [Практика 4: Пишем глобальный Docker Compose бэкенда мониторинга](https://github.com/lamjob1993/docker-monitoring/blob/main/docker/task_4.md)
- [Практика 5: Пишем Docker Compose для обкатки переменных в Grafana](https://github.com/lamjob1993/docker-monitoring/blob/main/docker/task_5.md)
