...
Команда ADD устрарела (она сразу копирует и распаковывает указанный архив в отличие от COPY - могут спросить на собеседовании). Для лучших практик используем:
```
